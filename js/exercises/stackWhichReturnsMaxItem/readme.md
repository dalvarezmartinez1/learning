# Implement a MaxStack (based on Stack) which returns the max

** Given an implementation of a Stack, implement a MaxStack which returns the maximum element in the stack**
